...
const HomePage = () => {
  ...
  return (
    <div className="bg-white text-slate-900">
      {/* HERO */}
      <section className="relative isolate w-full min-h-[50vh] sm:min-h-[55vh] md:min-h-[58vh] lg:min-h-[62vh] max-h-[78vh] overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto flex min-h-[32vh] flex-col justify-center px-4 py-6 sm:py-8 md:max-w-5xl lg:max-w-6xl lg:py-12">
