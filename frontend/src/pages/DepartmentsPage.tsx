      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        <div className="mx-auto w-full max-w-6xl">
          <div className="mb-6 rounded-3xl bg-gradient-to-r from-blue-900 to-blue-700 px-5 py-8 text-white shadow-lg sm:mb-8 sm:px-6 sm:py-10">
            ...
            <h1 className="mt-2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">{t("departments.title")}</h1>
            <p className="mt-3 text-sm sm:text-base md:text-lg text-blue-100">{t("departments.description")}</p>
          </div>
