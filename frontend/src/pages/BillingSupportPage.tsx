    ...
    <div className="bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-900">
      <div className="mx-auto w-full max-w-7xl px-4 py-12">
        <PageShell
          ...
          subtitle="Understand your charges, insurance coordination, and payment options with clear hospital policies."
          eyebrow="Financial care"
          kicker="Support"
          accent="#0ea5e9"
        >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-white/85 p-6 shadow-md ring-1 ring-slate-200 backdrop-blur">
              ...
              <p className="mt-2 text-base font-semibold text-slate-900">Billing Desk: {t("common.hotlineNumber")}</p>
            </div>
            <div className="rounded-3xl bg-white/85 p-6 shadow-md ring-1 ring-slate-200 backdrop-blur">
              ...
              <p className="mt-2 text-base font-semibold text-slate-900">billing@horizonhospital.com</p>
            </div>
          </div>
        </PageShell>
      </div>
